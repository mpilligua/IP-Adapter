...
path_save_imgs = f"{run}/imgs-{ckpt}/"
...
eval_dataset = CustomDataset(size=512, tokenizer=tokenizer)
...
for i, batch in enumerate(eval_dataloader):
    ...
    images = ip_model.generate(pil_image=batch["input_images"], num_samples=3, num_inference_steps=50, seed=42, strength=0.6, text_input_ids=batch["condition_texts"]) 
